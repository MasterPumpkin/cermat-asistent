...
```mermaid
graph TD
    A[1. Nastavte kraj & spádová města v Sidebaru] --> B[2. Vyberte prospěch na vysvědčení]
    B --> C[3. Zadejte cvičné body ČJL & MAT]
    C --> D[4. Zkontrolujte souhrnný zelený banner nahoře]
    D --> E[5. Prohlédněte si tabulku škol & DiPSy strategii]
    E --> F[6. Využijte Reverzní kalkulačku & Plán B]
```
